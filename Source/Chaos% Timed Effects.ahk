...
MonstertruckData:
PlayerWeightOffset := 0xB8
PlayerWeightOriginal := 70
PlayerWeightTarget := 700000
CarHealthOffset := 0x204
CarHealthTarget := 1000.0
%TimedEffectName%ContinuouslyActivate = 1
return

MonstertruckActivate:
PlayerWeightAddress := Memory(5, PlayerPointer, PlayerWeightOffset)
if (Memory(3, PlayerWeightAddress, 4, "Float") != PlayerWeightTarget)
	Memory(4, PlayerWeightAddress, PlayerWeightTarget, 4, "Float")
...
MonstertruckDeactivate:
PlayerWeightAddress := Memory(5, PlayerPointer, PlayerWeightOffset)
if (Memory(3, PlayerWeightAddress, 4, "Float") != PlayerWeightOriginal)
	Memory(4, PlayerWeightAddress, PlayerWeightOriginal, 4, "Float")
return
